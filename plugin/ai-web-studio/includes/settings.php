...
function aiwp_overview() {
    ...
    <div class="wrap aiwp-dashboard">
        ...
        <div class="aiwp-dashboard-grid">
            <section><span class="aiwp-step-number">01</span><h2>Popište stránku své AI</h2><p>Otevřete novou stránku a v bloku web-svepomoci-plugin klikněte na „Zkopírovat zadání pro AI“. Přidejte vlastní texty, barvy a požadavky.</p></section>
